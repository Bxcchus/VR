Shader "Campus Explorer/Modern Villa Visual/Transparent"
{
    Properties
    {
        _Color ("Base Color", Color) = (0.75,0.9,1,1)
        ...
        _SpecColor ("Specular Color", Color) = (0.08,0.08,0.08,1)
        [HDR] _EmissionColor ("Emission Color", Color) = (0,0,0,1)
        _EmissionIntensity ("Emission Intensity", Range(0,8)) = 0
        _Smoothness ("Fallback Smoothness", Range(0,1)) = 0.95
    ...
    SubShader
    {
        ...
        CGPROGRAM
        #pragma target 3.0
        #pragma surface surf StandardSpecular fullforwardshadows alpha:premul keepalpha
